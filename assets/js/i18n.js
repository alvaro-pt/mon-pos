...
(function (POS) {
  ...
  var STRINGS = {
    ...
    "nav.customers":   { pt: "Clientes",         en: "Customers" },
    "nav.options":     { pt: "Opções",           en: "Options" },
    "nav.settings":    { pt: "Definições",       en: "Settings" },
    "cust.search":     { pt: "Pesquisar cliente…", en: "Search customer…" },
    "cust.new":        { pt: "Novo cliente",     en: "New customer" },
    "cust.empty":      { pt: "Nenhum cliente encontrado.", en: "No customers found." },
    "cust.nif":        { pt: "NIF",              en: "TIN" },
    "cust.phone":      { pt: "Telefone",         en: "Phone" },
    "cust.select":     { pt: "Selecionar",       en: "Select" },
    ...
    "user.switchTerminal": { pt: "Trocar terminal", en: "Switch terminal" },
    ...
    "cart.empty.title":  { pt: "Venda vazia",         en: "Empty sale" },
    ...
    "cart.removeConfirm":{ pt: "Remover artigo?",    en: "Remove item?" },
    ...
    "disc.voucher":        { pt: "Talão de desconto",       en: "Discount voucher" },
    "disc.voucherCode":    { pt: "Código do talão",         en: "Voucher code" },
    "disc.voucherInvalid": { pt: "Código inválido.",        en: "Invalid code." },
    "disc.voucherDuplicate": { pt: "Talão já aplicado.",   en: "Voucher already applied." },
    "disc.voucherApplied": { pt: "Talão aplicado!",        en: "Voucher applied!" },
    "disc.noVouchers":     { pt: "Sem talões aplicados.",  en: "No vouchers applied." },
    "disc.globalTitle2":   { pt: "Desconto global",        en: "Global discount" },

    // Totais
    "tot.discount":  { pt: "Desconto",  en: "Discount" },
    "tot.discounts": { pt: "Descontos", en: "Discounts" },
    "tot.tax":       { pt: "IVA",       en: "Tax" },
    "tot.noVat":     { pt: "sem IVA",  en: "excl. VAT" },
    "tot.mixed":     { pt: "misto",    en: "mixed" },
    ...
    "act.editDisc":   { pt: "Editar desconto",   en: "Edit discount" },
    ...
    "cat.viewList":    { pt: "Vista em lista", en: "List view" },
    "cat.viewGrid":    { pt: "Vista em grelha", en: "Grid view" },
    ...
    "pd.addFav":    { pt: "Favorito",          en: "Favourite" },
    ...
    "doc.invoice":       { pt: "Fatura",              en: "Invoice" },
    "doc.deliveryNote":  { pt: "Guia de transporte",  en: "Delivery note" },
    ...
    "pay.docOptions":     { pt: "Opções",              en: "Options" },
    "pay.cartSummary":    { pt: "Resumo da venda",     en: "Sale summary" },
    "pay.noPayments":     { pt: "Sem pagamentos adicionados", en: "No payments added" },
    "pay.issueDate":      { pt: "Data de emissão",     en: "Issue date" },
    "pay.notes":          { pt: "Observações",         en: "Notes" },
    "pay.notesPlaceholder": { pt: "Observações (opcional)…", en: "Notes (optional)…" },
    "pay.transport":      { pt: "Dados de transporte", en: "Transport data" },
    "pay.transport.load": { pt: "Local de carga",      en: "Loading location" },
    "pay.transport.unload":{ pt: "Local de descarga",  en: "Unloading location" },
    "pay.transport.addr": { pt: "Morada",              en: "Address" },
    "pay.transport.zip":  { pt: "Código postal",       en: "Postal code" },
    "pay.transport.city": { pt: "Localidade",          en: "City" },
    "pay.transport.dtStart": { pt: "Início do transporte", en: "Transport start" },
    "pay.transport.required": { pt: "Obrigatório",     en: "Required" },
    "pay.transport.needData": { pt: "Preenche os dados de transporte obrigatórios (GT)", en: "Fill required transport data (GT)" },
    ...
    "pay.dest.offer":    { pt: "Talão de oferta",         en: "Gift receipt" },
    "pay.dest.sent":     { pt: "Recibo enviado",         en: "Receipt sent" },
    "pay.dest.printing": { pt: "A imprimir…",            en: "Printing…" },
    "pay.advanced":      { pt: "Mais opções",            en: "More options" },
